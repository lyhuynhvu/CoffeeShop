...
//    private JTextField txtMa = new JTextField("", 20);
    ...
    public void loadForm() {
        try {
            int i = MenuManagement.tblSP.getSelectedRow();
            txtName.setText(MenuManagement.tblSP.getModel().getValueAt(i, 1).toString());
            txtPrice.setText(MenuManagement.tblSP.getModel().getValueAt(i, 2).toString());
            txtType.setText(MenuManagement.tblSP.getModel().getValueAt(i, 3).toString());
            String stt = MenuManagement.tblSP.getModel().getValueAt(i, 4).toString();
            ...
            String img = MenuManagement.tblSP.getModel().getValueAt(i, 5).toString();
    ...
    private void btOKMouseClicked(java.awt.event.MouseEvent evt) {
        ...
        if (actionForm == "create") {
            ...
            if (val) {
                int i = MenuManagement.tblSP.getSelectedRow();
                menuDTO.id = Integer.parseInt(MenuManagement.tblSP.getModel().getValueAt(i, 0).toString());
